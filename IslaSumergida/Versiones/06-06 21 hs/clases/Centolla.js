class Centolla extends Objeto {
  ...
  _particulasCentolla() {
    ...
    let y = this.topY;
    this.particles.push(new Particle(xIzq, y, this.peso));

    this.particles.push(new Particle(xDer, y, this.peso));
  ...
  _armarPiernaIzq(particula, particulaBajo) {
    ...
    this.particlesPierna.push(new Particle(particula.x - tam, particula.y, this.peso));
    this.particlesPierna.push(new Particle(particula.x, particula.y + tam, this.peso));
    this.particlesPierna.push(
      new Particle(particula.x - tam, particula.y + tam, this.peso)
    );
