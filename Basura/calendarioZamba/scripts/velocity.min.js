    ...
    return (function (a, b, c, d) {
      ...
      function l(a, b) {
        ...
        return (
          u.isString(a)
            ? y.Easings[a] || (c = !1)
            : (c = u.isArray(a) && 1 === a.length ? j.apply(null, a) : u.isArray(a) && 2 === a.length ? z.apply(null, a.concat([b])) : !(!u.isArray(a) || 4 !== a.length) && k.apply(null, a)),
                    ...
                    if (z.hasOwnProperty(F) && "element" !== F) {
                      ...
                      if (((H.currentValue = G), "tween" === F)) q = G;
                        ...
                        A.Hooks.registered[F] &&
                          (A.Normalizations.registered[L] ? (g(B).rootPropertyValueCache[L] = A.Normalizations.registered[L]("extract", null, N[1])) : (g(B).rootPropertyValueCache[L] = N[1])),
                          "transform" === N[0] && (D = !0);
                      }
                    }
            ...
            if ("scroll" === G) {
              ...
              var H = function (e, f) {
                    ...
                    if (/[\d\.-]/.test(H) && /[\d\.-]/.test(I)) {
                      ...
                      if (((z += O.length), (B += P.length), O === P)) J === K ? (g += J + O) : ((g += "{" + C.length + (F ? "!" : "") + "}" + O), C.push(parseFloat(J)), D.push(parseFloat(K)));
                        ...
                        var Q = parseFloat(J),
                          R = parseFloat(K);
                        (g +=
                          (E < 5 ? "calc" : "") + "(" + (Q ? "{" + C.length + (F ? "!" : "") + "}" : "0") + O + " + " + (R ? "{" + (C.length + (Q ? 1 : 0)) + (F ? "!" : "") + "}" : "0") + P + ")"),
                          Q && (C.push(Q), D.push(0)),
                          R && (C.push(0), D.push(R));
                      }
                    } else {
                ...
                g ||
                  ...
                  (p = parseFloat(p) || 0),
                  "%" === t &&
                    (/^(fontSize|lineHeight)$/.test(e) ? ((p /= 100), (t = "em")) : /^scale/.test(e) ? ((p /= 100), (t = "")) : /(Red|Green|Blue)$/i.test(e) && ((p = (p / 100) * 255), (t = ""))));
                if (/[\/*]/.test(w)) t = v;
                else if (v !== t && 0 !== r)
                  if (0 === p) t = v;
                  else {
                ...
                (j[e] = { rootPropertyValue: m, startValue: r, currentValue: r, endValue: p, unitType: t, easing: q }),
                  g && (j[e].pattern = g),
                ...
                return (
                  ...
                  o.each(r, function (a, b) {
                    parseFloat(j.stagger) ? (j.delay = K + parseFloat(j.stagger) * a) : u.isFunction(j.stagger) && (j.delay = K + j.stagger.call(b, a, C)),
                      j.drag &&
                        ((j.duration = parseFloat(J) || (/^(callout|transition)/.test(s) ? 1e3 : w)),
                        (j.duration = Math.max(j.duration * (j.backwards ? 1 - a / C : (a + 1) / C), 0.75 * j.duration, 200))),
